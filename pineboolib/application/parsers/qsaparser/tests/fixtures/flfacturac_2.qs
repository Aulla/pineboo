...
function interna_init()
{
  var _i = this.iface;
  var util = new FLUtil;
  var cursor = this.cursor();  connect(cursor, "bufferChanged(QString)", _i, "bufferChanged");  _i.habilitaPorClave();
...
}function oficial_habilitaPorClave()
{
  ...
  switch (cursor.valueBuffer("operacion")) {
    ...
    default: {
      ...
      this.child("fdbCodSituInmueble").setValue("");      this.child("gbxCriterioCaja").enabled = false;
