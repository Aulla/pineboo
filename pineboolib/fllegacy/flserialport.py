...
class BaudRateType(QtSerialPort.QSerialPort.BaudRate):
    """BaudRateType class."""
...
class DataBitsType(QtSerialPort.QSerialPort.DataBits):
    """DataBitsType class."""
...
class ParityType(QtSerialPort.QSerialPort.Parity):
    """ParityType class."""
...
class StopBitType(QtSerialPort.QSerialPort.StopBits):
    """StopBitType class."""
...
class FlowType(QtSerialPort.QSerialPort.FlowControl):
    """FlowType class."""
