...
# --- Metadata ---> 
    legacy_metadata = {'name' : 'flupdates', 'alias' : 'Registro de instalaciÃ³n/actualizaciÃ³n de paquetes', 
        ...
        {'name' : 'modulesdef', 'alias' : 'Modules Def.', 'type' : 'stringlist', 'null' : False, 'visible' : False, 'visiblegrid' : False, 'editable' : False},
        {'name' : 'filesdef', 'alias' : 'Files Def.', 'type' : 'stringlist', 'null' : False, 'visible' : False, 'visiblegrid' : False, 'editable' : False},
        {'name' : 'shaglobal', 'alias' : 'SHA1 Global', 'type' : 'string', 'length' : 255, 'null' : False, 'visible' : False, 'visiblegrid' : False, 'editable' : False},
        {'name' : 'auxtxt', 'alias' : 'Auxiliar Texto', 'type' : 'stringlist', 'visible' : False, 'visiblegrid' : False, 'editable' : False},
        {'name' : 'auxbin', 'alias' : 'Auxiliar Binario', 'type' : 'bytearray', 'visible' : False, 'visiblegrid' : False, 'editable' : False}
        ]}
