...
./configure CXXFLAGS="—Os -DSQLITE_ENABLE_UNLOCK_NOTIFY=1 -arch arm64 -std=c++14 -stdlib=libc++" CC="clang" CXX="clang++" LD="ld" AR="ar" --disable-shared --enable-static --enable-dynamic-extensions
